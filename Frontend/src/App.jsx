...
function App() {
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      <header className="fixed top-0 left-0 w-full bg-white shadow-md overflow-hidden">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center">
          ...
          <ul className="flex gap-2 sm:gap-4 md:gap-8 items-center text-xs sm:text-sm md:text-base">
            ...
            <li><a href="#login" className="bg-orange-600 text-white px-3 sm:px-4 md:px-6 py-2 rounded-lg hover:bg-orange-700 transition whitespace-nowrap">Login</a></li>
          </ul>
        </nav>
      </header>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <a href="#get-started" className="bg-white text-orange-600 px-6 sm:px-8 py-3 rounded-lg font-semibold hover:bg-orange-50 transition text-center">Get Started</a>
              <a href="#about" className="border-2 border-white text-white px-6 sm:px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-orange-600 transition text-center">Learn More</a>
            </div>
          </div>
          <div className="block">
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-gradient-to-br from-orange-500 to-orange-600 text-white">
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a href="#get-started" className="inline-block bg-orange-600 text-white px-8 sm:px-10 py-3 sm:py-4 rounded-lg text-base sm:text-lg font-semibold hover:bg-orange-700 transition">Get Started Now</a>
        </div>
      </section>
      <footer id='contact' className="bg-gray-900 text-white py-8 sm:py-12 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-500 text-xs sm:text-sm">For more details visit gradious.com</p><br></br>
          <p className="text-gray-500 text-xs sm:text-sm">© 2024 TimeTrack Pro. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
