          ...
          <div className="mt-10 bg-white rounded-lg shadow-md p-6">
            ...
            <div className="flex justify-center gap-3">
              <select
                value={selectedProject}
                onChange={(e) => setSelectedProject(e.target.value)}
                className="border border-gray-300 px-3 py-2 rounded-lg text-m"
              >
                <option value="">Select Project</option>
                {projects.map(p => (
                  <option key={p._id} value={p._id}>
              ...
              <button
                onClick={handleProjectExpandAll}
                className="bg-blue-600 text-white px-4 py-2 rounded-lg text-m hover:bg-blue-700 transition"
              >
                {projectExpandAll ? "Collapse All" : "Expand All"}
              </button>
            </div>
                            ...
                            <tbody>
                              {projectDetailsData[emp._id]?.map((p, idx) => (
                                <>
                                  ...
                                  >
                                    <td className="px-4 py-2 font-medium text-gray-800 text-left align-middle">
