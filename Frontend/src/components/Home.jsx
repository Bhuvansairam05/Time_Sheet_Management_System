              ...
              <div className="bg-white rounded-lg shadow-2xl p-6 sm:p-8 text-gray-800">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    ...
                    <span className="text-orange-600 font-bold text-lg sm:text-xl">{stats.totalProjects}</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="font-semibold text-sm sm:text-base">Active Users</span>
                    <span className="text-orange-600 font-bold text-lg sm:text-xl">{stats.activeUsers}</span>
                  </div>
                </div>
              </div>
            </div>
