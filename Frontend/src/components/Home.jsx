  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      <div className="min-h-screen bg-white overflow-x-hidden">
          ...
          <nav className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center">
            ...
            <ul className="flex gap-2 sm:gap-4 md:gap-8 items-center text-xs sm:text-sm md:text-base">
              <li className="hidden sm:block">
                <a href="#features" className="text-gray-700 hover:text-blue-700 transition whitespace-nowrap">
                  Features
                </a>
              </li>
              <li className="hidden md:block">
                <a href="#about" className="text-gray-700 hover:text-blue-700 transition whitespace-nowrap">
                  About
                </a>
              </li>
              <li className="hidden md:block">
                <a href="#contact" className="text-gray-700 hover:text-blue-700 transition whitespace-nowrap">
                  Contact
                </a>
              </li>
              <li>
                <button
                  ...
                  className="bg-blue-700 text-white px-3 sm:px-4 md:px-6 py-2 rounded-lg hover:bg-blue-800 transition whitespace-nowrap"
                >
                  Login
                </button>
              </li>
        ...
        <section className="pt-20 sm:pt-24 md:pt-32 pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 bg-gradient-to-br from-blue-900 to-blue-600 text-white overflow-hidden">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
              ...
              <p className="text-base sm:text-lg md:text-xl mb-6 sm:mb-8 text-blue-100">Efficient time sheet management for teams. Track tasks, manage projects, and boost productivity with ease.</p>
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <button onClick={openLoginModal} className="bg-white text-blue-700 px-6 sm:px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 transition text-center">Get Started</button>
                <a href="#features" className="border-2 border-white text-white px-6 sm:px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-700 transition text-center">Learn More</a>
              </div>
            </div>
            <div className="block">
              <div className="bg-white rounded-lg shadow-2xl p-6 sm:p-8 text-gray-800">
                <h3 className="text-xl sm:text-2xl font-bold mb-4 text-blue-700">Quick Stats</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="font-semibold text-sm sm:text-base">Projects Managed</span>
                    <span className="text-blue-700 font-bold text-lg sm:text-xl">{stats.totalProjects}</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <span className="font-semibold text-sm sm:text-base">Active Users</span>
                    <span className="text-blue-700 font-bold text-lg sm:text-xl">{stats.activeUsers}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section id="features" className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-white">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              <div className="bg-blue-50 p-6 sm:p-8 rounded-lg border-2 border-blue-200 hover:border-blue-700 transition">
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-blue-700 rounded-full flex items-center justify-center mb-4 sm:mb-6 mx-auto">
              ...
              <div className="bg-blue-50 p-6 sm:p-8 rounded-lg border-2 border-blue-200 hover:border-blue-700 transition sm:col-span-2 lg:col-span-1">
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-blue-700 rounded-full flex items-center justify-center mb-4 sm:mb-6 mx-auto">
        ...
        <section id="about" className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-gradient-to-br from-blue-600 to-blue-900 text-white">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold text-center mb-10 sm:mb-16">How It Works</h2>

            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              <div className="text-center">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white text-blue-700 rounded-full flex items-center justify-center text-2xl sm:text-3xl font-bold mx-auto mb-3 sm:mb-4">1</div>
                <h3 className="text-lg sm:text-xl font-bold mb-2">Login</h3>
                <p className="text-sm sm:text-base text-blue-100">Access your personalized dashboard</p>
              </div>

              <div className="text-center">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white text-blue-700 rounded-full flex items-center justify-center text-2xl sm:text-3xl font-bold mx-auto mb-3 sm:mb-4">2</div>
                <h3 className="text-lg sm:text-xl font-bold mb-2">Check-In</h3>
                <p className="text-sm sm:text-base text-blue-100">Start your work day with one click</p>
              </div>

              <div className="text-center">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white text-blue-700 rounded-full flex items-center justify-center text-2xl sm:text-3xl font-bold mx-auto mb-3 sm:mb-4">3</div>
                <h3 className="text-lg sm:text-xl font-bold mb-2">Add Tasks</h3>
                <p className="text-sm sm:text-base text-blue-100">Log tasks and time spent</p>
              </div>

              <div className="text-center">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white text-blue-700 rounded-full flex items-center justify-center text-2xl sm:text-3xl font-bold mx-auto mb-3 sm:mb-4">4</div>
                <h3 className="text-lg sm:text-xl font-bold mb-2">Submit</h3>
                <p className="text-sm sm:text-base text-blue-100">Send to manager for approval</p>
              </div>
            </div>
          </div>
        </section>
